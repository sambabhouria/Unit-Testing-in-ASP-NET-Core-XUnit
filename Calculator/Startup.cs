...
namespace Calculator
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            /*
             * We have added the Maths service so now lets register this service in the dependency injection
             * container so that we can inject this service into the controller using the constuctor of the 
             * controller 
             */
